  ...
  TableScan: test"#;
    ...
    fn simplify_not_unknown() {
        ...
        let plan = LogicalPlanBuilder::from(table_scan)
            ...
            .build()
            .unwrap();
        let expected = "Filter: test.d IS NOT UNKNOWN\
        \n  TableScan: test";
    ...
    fn simplify_not_not_unkonwn() {
        ...
        let plan = LogicalPlanBuilder::from(table_scan)
            ...
            .build()
            .unwrap();
        let expected = "Filter: test.d IS UNKNOWN\
        \n  TableScan: test";
    ...
    fn simplify_not_true() {
        ...
        let plan = LogicalPlanBuilder::from(table_scan)
            ...
            .build()
            .unwrap();
        let expected = "Filter: test.d IS NOT TRUE\
        \n  TableScan: test";
    ...
    fn simplify_not_not_true() {
        ...
        let plan = LogicalPlanBuilder::from(table_scan)
            ...
            .build()
            .unwrap();
        let expected = "Filter: test.d IS TRUE\
        \n  TableScan: test";
    ...
    fn simplify_not_false() {
        ...
        let plan = LogicalPlanBuilder::from(table_scan)
            ...
            .build()
            .unwrap();
        let expected = "Filter: test.d IS NOT FALSE\
        \n  TableScan: test";
    ...
    fn simplify_not_not_false() {
        ...
        let plan = LogicalPlanBuilder::from(table_scan)
            ...
            .build()
            .unwrap();
        let expected = "Filter: test.d IS FALSE\
        \n  TableScan: test";
